<?php
	...
	{
		$cust_id      = $_REQUEST['id'];
		$crow         = checkExist('tbl_customer',array('cust_id'=>$cust_id));
        if($crow)
        {
	...
	$feature_name 		= 'Buyer Update'; // $row_feature[1];
	$home_name    		= "Home";
        ...
        <div class="container-fluid" id="content">
        	<div id="main" style="margin-left:0px !important">
            	<div class="container-fluid" id="div_view_spec">
					<?php
                    /* this function used to add navigation menu to the page*/
                    breadcrumbs($home_url,$home_name,'Buyer Detail',$filename,$feature_name);
                    /* this function used to add navigation menu to the page*/
                    ?>
                    <div class="row-fluid">
                        <div class="span12">
                                ...
                                <div class="box-content nopadding">
                                	...
                                	<form id="frm_add_prod" class="form-horizontal form-bordered form-validate" enctype="multipart/form-data" >
                                    	...
                                    	<div class="control-group">
                                            ...
                                            <div class="controls">
                                                	<input   type="text" placeholder="Name" id="cust_name" name="cust_name" class="input-xlarge" value="<?php echo @$crow['cust_name']; ?>" data-rule-required="true" />
                                            </div>
                                        </div><!--Category=====-->
                                        ...
                                        <div class="control-group span6">
                                            ...
                                            <div class="controls">
                                                	<input   type="email" placeholder="Email" id="cust_email" name="cust_email" class="input-xlarge" value="<?php echo @$crow['cust_email']; ?>" data-rule-required="true" />
                                            </div>
                                        </div>	<!-- Product Name -->
                                       ...
                                       <div class="control-group span6">
                                            ...
                                            <div class="controls">
                                                	<input   type="text" placeholder="Mobile Number" id="cust_mobile" name="cust_mobile" class="input-xlarge" value="<?php echo @$crow['cust_mobile']; ?>" data-rule-required="true" minlength="10" maxlength="10" onkeypress="return numsonly(event)" />
                                            </div>
                                        </div><!--Category=====-->
									</form>
                                </div>
                                ...
                                <div class="box-content nopadding" id="lic_div" style="display: none">
                                    ...
                                    <form id="frm_lic_info" class="form-horizontal form-bordered form-validate" enctype="multipart/form-data" >
                                      ...
                                      if($crow['cust_type']=="trader")
                                       ...
                                       }//if customer type trader
                                        if($crow['cust_type']=="doctors")
                                        {

                                            $licRow = checkExist('tbl_customer_licenses',array('lic_custid'=>$cust_id,'lic_type'=>''));
                                            if(!$licRow) // for add and update in single form 
                                            {
                                              
                                                echo '<input type="hidden" value="1" name="add_doctor_lic_req" />';
                                                $required          = 'data-rule-required="true"';
                                            }
                                              else
                                            {
                                             
                                              echo '<input type="hidden" value="1" name="update_doctor_lic_req" />';
                                              $required          = '';
                                            }?>
                                          
                                            <div class="control-group">
                                                <label for="tasktitel" class="control-label">Drug License Number<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                <div class="controls">
                                                        <input   type="text" placeholder="Drug License Number" id="txt_lic_no" name="txt_lic_no" class="input-xlarge" value="<?php echo $licRow['lic_number']; ?>" data-rule-required="true"  />
                                                </div>
                                            </div><!--Drug License Number=====-->

                                            <div class="control-group">
                                                <label for="tasktitel" class="control-label">Drug License Image<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                <div class="controls">
                                                        <?php
                                                        if(isset($licRow['lic_document']) && $licRow['lic_document']!="")
                                                        {
                                                            $ext  =  explode('.',$licRow['lic_document']);
                                                            if($ext[sizeof($ext)-1]=='pdf')
                                                            {

                                                             echo '<br> <a href="documents/licenses/'.@$licRow['lic_document'].'" >'.$licRow['lic_document'].'</a>';
                                                            }else
                                                            {
                                                                echo '<br> <img width="100" id="licRow" onclick="showImg(this.id)"  height="200" src="documents/licenses/'.@$licRow['lic_document'].'" />';
                                                            }
                                                            echo '<br>';
                                                        }
                                                        ?>
                                                        <input accept="image/jpeg,image/png,image/jpg,application/pdf" type="file" name="file_lic_image" id="file_lic_image" data-rule-requied="true" <?php echo $required; ?>>
                                                </div>
                                            </div><!--Drug License Image=====-->
                                        <?php
                                         }//if customer type doctors
                                         

                                         if($crow['cust_type']=="hospitals")
                                         {

                                            $licRow = checkExist('tbl_customer_licenses',array('lic_custid'=>$cust_id));
                                            $result = getRecord('tbl_customer_licenses',array('lic_custid'=>$cust_id),array('lic_type'=>'New'));
                                            $licNum = isExist('tbl_customer_licenses',array('lic_custid'=>$cust_id),array('lic_type'=>'New'));
                                            if(!$licRow) // for add and update in single form 
                                            {
                                              
                                                echo '<input type="hidden" value="1" name="add_hospital_lic_req" />';
                                                $required          = 'data-rule-required="true"';
                                            }
                                              else
                                            {
                                             
                                              echo '<input type="hidden" value="1" name="update_hospital_lic_req" />';
                                              $required          = '';
                                            }?>
                                            ...
                                            <div class="control-group">
                                                <label for="tasktitel" class="control-label">Hospital Drug License Number<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                <div class="controls">
                                                        <input   type="text" placeholder="Drug License Number" id="txt_hospital_lic_no" name="txt_hospital_lic_no" class="input-xlarge" value="<?php echo @$licRow['lic_number']; ?>" data-rule-required="true"  />
                                                </div>
                                            </div><!--Drug License Number=====-->
                                            ...
                                            <div class="control-group">
                                                <label for="tasktitel" class="control-label">Hospital Drug License Expiry Date<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                <div class="controls">
                                                        <input   type="text" placeholder="Expiry Date" id="lic_hospital_date" name="lic_hospital_date" class="input-xlarge datepicker" value="<?php echo @$licRow['lic_exipiry_date']; ?>"  />
                                                </div>
                                            </div><!--21C Date=====-->
                                            ...
                                            if($result)
                                            {
                                                ...
                                                while($row  = mysqli_fetch_array($result))
                                                {
                                                    $i++;  ?> 
                                                    <div class="control-group">
                                                    <label for="tasktitel" class="control-label">Renewal <?php echo $i; ?> Hospital Drug License Number<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                    <div class="controls">
                                                            <input   type="text" placeholder="Drug License Number" id="txt_hospital_lic_no<?php echo $i; ?>" name="txt_hospital_lic_no<?php echo $i; ?>" class="input-xlarge" value="<?php echo @$row['lic_number']; ?>" data-rule-required="true"  />
                                                    </div>
                                                    </div><!--Drug License Number=====-->

                                                    <div class="control-group">
                                                        <label for="tasktitel" class="control-label">Renewal <?php echo $i; ?> Drug License Image<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                        <div class="controls">
                                                                <?php
                                                                if(isset($row['lic_document']) && $row['lic_document']!="")
                                                                {
                                                                    $ext  =  explode('.',$row['lic_document']);
                                                                    if($ext[sizeof($ext)-1]=='pdf')
                                                                    {

                                                                     echo '<br> <a href="documents/licenses/'.@$row['lic_document'].'" >'.$row['lic_document'].'</a>';
                                                                    }else
                                                                    {
                                                                        echo '<br> <img width="100" id="licRow'.$i.'" onclick="showImg(this.id)"  height="200" src="documents/licenses/'.@$row['lic_document'].'" />';
                                                                    }
                                                                    echo '<br>';
                                                                }
                                                                ?>
                                                                <input accept="image/jpeg,image/png,image/jpg,application/pdf" type="file" name="file_lic_image<?php echo $i; ?>" id="file_lic_image<?php echo $i; ?>" data-rule-requied="true" <?php echo $required; ?>>
                                                        </div>
                                                    </div><!--Drug License Image=====-->
                                                    ...
                                                    <div class="control-group">
                                                        <label for="tasktitel" class="control-label">Hospital Drug License Expiry Date<sup class="validfield"><span style="color:#F00;font-size:20px;">*</span></sup></label>
                                                        <div class="controls">
                                                                <input   type="text" placeholder="Expiry Date" id="lic_hospital_date<?php echo $i; ?>" name="lic_hospital_date<?php echo $i; ?>" class="input-xlarge datepicker" value="<?php echo @$row['lic_exipiry_date']; ?>"  />
                                                        </div>
                                                    </div><!--21C Date=====-->
                                            <?php 
                                                 }
                                ...
                                <div class="box-content nopadding" id="pan_div" style="display: none">
                                    ...
                                    <form id="frm_pan_info" class="form-horizontal form-bordered form-validate" enctype="multipart/form-data" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input   type="text" placeholder="Pan Number" id="pan_no" name="pan_no" class="input-xlarge" value="<?php echo @$pan_row['pan_no']; ?>" data-rule-required="true" />
                                            </div>
                                        </div><!--Category=====-->
				...
				$.ajax({
					...
					success: function(response) 
					{
						...
						if(data.Success == "Success") 
						{
							...
							alert(data.resp);
							window.location.assign("ae_buyer.php?pag=Buyers&id=<?php echo $cust_id; ?>");
						} 
						else 
						{
							//alert("Wrong Entries");
