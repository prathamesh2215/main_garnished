                        ...
                        <div class="span12">
                                	...
                                	<form id="frm_add_prod" class="form-horizontal form-bordered form-validate" enctype="multipart/form-data" >
                                       ...
                                       <div class="control-group " style="clear:both">
                                        ...
                                        <div class="control-group ">
                                           ...
                                           <br><span class="" style="color:red">
						   Only Image "jpeg","jpg","png","gif" will be accepted.<br>
						   Image size should be less  than '5' Mb.
                                        ...
                                        <div class="control-group span6" id="div_form_factor">
                                            ...
                                            <div class="controls">
	                                            <select name="txt_factor" id="txt_factor"  class = "select2-me input-xlarge"  required>
	                                            	<?php
												// Query For getting all categories from the system
                                        ...
                                        <div class="control-group span4">
                                           ...
                                           <div class="controls">
                                            <input placeholder="Dimension Length in CM" type="text" name="txt_dimensionl" id="txt_dimensionl"   data-rule-required="true"  class=" input-large" style="" />
                                           </div>
                                        ...
                                        <div class="control-group span4">
                                           ...
                                           <div class="controls">
                                            <input placeholder="Dimension Height in CM" type="text" name="txt_dimensionh" id="txt_dimensionh"  data-rule-required="true"  class=" input-large" style="" />
                                           </div>
                                        ...
                                        <div class="control-group span4">
                                           ...
                                           <div class="controls">
                                            <input placeholder="Dimension Width in CM" type="text" name="txt_dimensionw" id="txt_dimensionw"  data-rule-required="true"   class=" input-large" style="" />
                                           </div>
