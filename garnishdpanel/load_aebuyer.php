<?php
	...
	if((isset($_POST['hid_frm_comp_info']))== '1' && (isset($_POST['hid_frm_comp_info'])))
	{
		...
		$data['comp_ship_city']		= mysqli_real_escape_string($db_con,$_POST['txt_ship_city']);
		$data['comp_ship_pincode']	= mysqli_real_escape_string($db_con,$_POST['txt_ship_pincode']);
		$data['comp_descp']			= mysqli_real_escape_string($db_con,$_POST['txt_description']);
		$data['comp_pickuptime']			= mysqli_real_escape_string($db_con,$_POST['txt_pickuptime']);
		$data['comp_timedesc']			= mysqli_real_escape_string($db_con,$_POST['txt_timedescription']);
	...
	if((isset($_POST['add_pan_req']))== '1' && (isset($_POST['add_pan_req'])))
	{
		...
		$dir                          = 'documents/pan/'.$pan_image_name;
	...
	if((isset($_POST['update_pan_req']))== '1' && (isset($_POST['update_pan_req'])))
	{
		...
		if(isset($_FILES['file_pan_image']['name']) && $_FILES['file_pan_image']['name']!="")
		{
			...
			if(move_uploaded_file($_FILES['file_pan_image']['tmp_name'],$dir))
			{
				unlink('documents/pan/'.$panRow['pan_image']);
	...
	// ===============================================================================
	// End : Pan Information Dn By Satish On 14 Jan 2018
	// ===============================================================================
	
	
	// ===============================================================================
	// START : TAN Information Dn By Satish 14 Jan 2018
	// ===============================================================================
	if((isset($_POST['add_tan_req']))== '1' && (isset($_POST['add_tan_req'])))
	{
		$data['tan_userid']  = mysqli_real_escape_string($db_con,$_POST['hid_userid']);
		$data['tan_no']      = mysqli_real_escape_string($db_con,$_POST['tan_no']);
		...
		$dir                          = 'documents/pan/'.$tan_image_name;
	...
	if((isset($_POST['update_tan_req']))== '1' && (isset($_POST['update_tan_req'])))
	{
		...
		if(isset($_FILES['file_tan_image']['name']) && $_FILES['file_tan_image']['name']!="")
		{
			...
			$dir                          = 'documents/tan/'.$tan_image_name;
			if(move_uploaded_file($_FILES['file_tan_image']['tmp_name'],$dir))
			{
				unlink('documents/tan/'.$panRow['tan_image']);
	...
	// ===============================================================================
	// End : TAN Information Dn By Satish On 14 Jan 2018
	// ===============================================================================

	// ===============================================================================
	// START : GST Information Dn By Satish On 14 Jan 2018
	// ===============================================================================
	if((isset($_POST['add_gst_req']))== '1' && (isset($_POST['add_gst_req'])))
	{
		$data['gst_userid']  = mysqli_real_escape_string($db_con,$_POST['hid_userid']);
		$data['gst_no']      = mysqli_real_escape_string($db_con,$_POST['gst_no']);
		...
		if(isset($_FILES['file_gst_ack_image2']['name'])&& $_FILES['file_gst_ack_image2']['name']!="")
		{
			...
			$gst_ack_image2_name               = explode('.',$_FILES['file_gst_ack_image2']['name']);
			$gst_ack_image2_name               = date('dhyhis').'_ACK2_'.$data['gst_userid'].'.'.$gst_ack_image2_name[1];
			$data['gst_ack_image2']            = $gst_ack_image2_name;
			$dir2                         	   = 'idbpanel/documents/gst/'.$gst_ack_image2_name;
		}
		...
		if(isset($_FILES['file_gst_ack_image3']['name']) && $_FILES['file_gst_ack_image3']['name']!="")
		{
			...
			$gst_ack_image3_name               = explode('.',$_FILES['file_gst_ack_image3']['name']);
			$gst_ack_image3_name               = date('dhyhis').'_ACK3_'.$data['gst_userid'].'.'.$gst_ack_image3_name[1];
			$data['gst_ack_image3']            = $gst_ack_image3_name;
			$dir3                        	   = 'idbpanel/documents/gst/'.$gst_ack_image3_name;
		}
		...
		if(isset($_FILES['file_gst_ack_image4']['name']) && $_FILES['file_gst_ack_image4']['name']!="")
		{
			...
			$gst_ack_image4_name               = explode('.',$_FILES['file_gst_ack_image4']['name']);
			$gst_ack_image4_name               = date('dhyhis').'_ACK4_'.$data['gst_userid'].'.'.$gst_ack_image4_name[1];
			$data['gst_ack_image4']            = $gst_ack_image4_name;
			$dir4                        	   = 'idbpanel/documents/gst/'.$gst_ack_image4_name;
		}
		//======================End  GST acknowledgement 4 Check==========================//
	...
	if((isset($_POST['update_gst_req']))== '1' && (isset($_POST['update_gst_req'])))
	{
		...
		if(isset($_FILES['file_gst_ack_image2']['name'])&& $_FILES['file_gst_ack_image2']['name']!="")
		{
			...
			$gst_ack_image2_name               = explode('.',$_FILES['file_gst_ack_image2']['name']);
			$gst_ack_image2_name               = date('dhyhis').'_ACK2_'.$where_arr['gst_userid'].'.'.$gst_ack_image2_name[1];
			$data['gst_ack_image2']            = $gst_ack_image2_name;
			$dir2                         	   = 'idbpanel/documents/gst/'.$gst_ack_image2_name;
			if(move_uploaded_file($_FILES['file_gst_ack_image2']['tmp_name'],$dir2))
			{
				if($gstRow['gst_ack_image2']!="")
				{
					unlink('idbpanel/documents/gst/'.$gstRow['gst_ack_image2']);
				}
			}
		...
		if(isset($_FILES['file_gst_ack_image3']['name'])&& $_FILES['file_gst_ack_image3']['name']!="")
		{
			...
			$gst_ack_image3_name               = explode('.',$_FILES['file_gst_ack_image3']['name']);
			$gst_ack_image3_name               = date('dhyhis').'_ACK3_'.$where_arr['gst_userid'].'.'.$gst_ack_image3_name[1];
			$data['gst_ack_image3']            = $gst_ack_image3_name;
			$dir3                        	   = 'idbpanel/documents/gst/'.$gst_ack_image3_name;
			
			if(move_uploaded_file($_FILES['file_gst_ack_image3']['tmp_name'],$dir3))
			{
				if($gstRow['gst_ack_image3']!="")
				{
					unlink('idbpanel/documents/gst/'.$gstRow['gst_ack_image3']);
				}
			}
		...
		if(isset($_FILES['file_gst_ack_image4']['name']) && $_FILES['file_gst_ack_image4']['name']!="")
		{
			...
			$gst_ack_image4_name               = explode('.',$_FILES['file_gst_ack_image4']['name']);
			$gst_ack_image4_name               = date('dhyhis').'_ACK4_'.$where_arr['gst_userid'].'.'.$gst_ack4_image_size[1];
			$data['gst_ack_image4']            = $gst_ack_image4_name;
			$dir4                        	   = 'idbpanel/documents/gst/'.$gst_ack_image4_name;
			
			if(move_uploaded_file($_FILES['file_gst_ack_image4']['tmp_name'],$dir4))
			{
				if($gstRow['gst_ack_image4']!="")
				{
					unlink('idbpanel/documents/gst/'.$gstRow['gst_ack_image4']);
				}
			}
		}
		//======================End  GST acknowledgement 4 Check==========================//
	...
	// ===============================================================================
	// End : GST Information Dn By Satish On 14 Jan 2018
	// ===============================================================================
	
	// ===============================================================================
	// START : Bank Information Dn By Satish On 14 Jan 2018
	// ===============================================================================
	if((isset($_POST['add_bank_req']))== '1' && (isset($_POST['add_bank_req'])))
	{
		$data['bank_userid']   = mysqli_real_escape_string($db_con,$_POST['hid_userid']);
		$data['bank_name']     = mysqli_real_escape_string($db_con,$_POST['bank_name']);
		$data['bank_username'] = mysqli_real_escape_string($db_con,$_POST['bank_username']);
		$data['bank_branch']   = mysqli_real_escape_string($db_con,$_POST['bank_branch']);
		$data['bank_acc_no']   = mysqli_real_escape_string($db_con,$_POST['bank_acc_no']);
		$data['bank_ifsc']     = mysqli_real_escape_string($db_con,$_POST['bank_ifsc']);
		$data['bank_created']  = $datetime;
		$data['bank_created_by']  = $uid;
		...
		$dir                          = 'documents/banks/'.$bank_image_name;
	...
	if((isset($_POST['update_bank_req']))== '1' && (isset($_POST['update_bank_req'])))
	{
		...
		$data['bank_modified']     = $datetime;
		$data['bank_modified_by']  = $uid;
	...
	// ===============================================================================
	// End : Bank Information Dn By Satish On 14 Jan 2018
	// ===============================================================================
	...
	if((isset($_POST['add_doctor_lic_req']))== '1' && (isset($_POST['add_doctor_lic_req'])))
	{
		...
		$data['lic_custid']        = $_POST['hid_userid'];
		...
		$dir                          = 'documents/licenses/'.$lic_image_name;
	...
	{
		$where_arr['lic_custid']  = $_POST['hid_userid'];
		$data['lic_number']       = mysqli_real_escape_string($db_con,$_POST['txt_lic_no']);
		...
		if(isset($_FILES['file_lic_image']['name']) && $_FILES['file_lic_image']['name']!="")
		{
			...
			if(move_uploaded_file($_FILES['file_lic_image']['tmp_name'],$dir))
			{
				unlink('documents/licenses/'.$licRow['lic_image']);
	...
	if((isset($_POST['update_hospital_lic_req']))== '1' && (isset($_POST['update_hospital_lic_req'])))
	{
		...
		if(isset($_FILES['file_lic_image']['name']) && $_FILES['file_lic_image']['name']!="")
		{
		    ...
		    {
				$data['lic_document']   = $lic_image_name;
				unlink('documents/licenses/'.$licRow['lic_document']);
			}
		}
	...
	// ===============================================================================
	// Start : Signatiure Dn By Satish On 14 Jan 2018
	// ===============================================================================
    ...
    if((isset($_POST['req_signature_info']))== '1' && (isset($_POST['req_signature_info'])))
    {
		...
		if($signRow)
		{
			if(isset($_FILES['img_sign_info']['name']) && $_FILES['img_sign_info']['name']!="")
			{
				...
				if($img_sign_info > 20000 &&  $img_sign_info !=0) // file size
				{
					quit('Image size should be less than 200 Kb'.$img_sign_info);
				}
				...
				$dir                          = 'documents/sign/'.$sign_image_name;
				if(move_uploaded_file($_FILES['img_sign_info']['tmp_name'],$dir))
				{
					unlink('documents/sign/'.$signRow['sign_doc']);
