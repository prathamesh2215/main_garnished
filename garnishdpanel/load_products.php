<?php
	...
	if((isset($obj->getImages)) == '1' && (isset($obj->getImages)))
	{
		...
		$data .= '<br><span class="" style="color:red">
		...
		$prod_row = checkExist('tbl_products' ,array('id'=>$prod_id));
		quit(array($data,ucwords($prod_row['prod_name'])),1);
