...
{
	$dbname = "indiapre_idb2017";
	$dbuser = "indiapre_idb2017";
	$dbpass = "Idb@2017";	
	
	$BaseFolder = "http://www.garnishd.com/garnishdpanel/";	
	include("../PHPMailer/class.phpmailer.php");}
...
{	
	if($email != "" && $subject != "" || $message !="")
	{
		...
		$mail->IsSMTP();                           
		$mail->Port       	= 25;                    
		$mail->Host       	= 'mail.garnishd.com'; 
		$mail->Username   	= 'support@garnishd.com';
		$mail->Password   	= 'support@123';    
		$mail->IsSendmail();       
		$mail->From     	= 'support@garnishd.com';
		$mail->FromName 	= 'Garnishd';
		$mail->AddAddress($email,$email);
		$mail->AddReplyTo('support@garnishd.com', 'Garnishd');
		$mail->WordWrap 	= 50;                             
		$mail->IsHTML(true);                              
...
function modelPopUp()
{
  ...
  <!-- ================================================ -->
  <!-- ============Start : For show image on popup ===-->
  <!-- The Modal -->
  <div id="myModal" class="imodal" style="margin-left:inset">
...
function mail_template_header()
{
	...
	$mail_message .= '<img src="http://www.garnishd.com/img/pe_logo.png" height="50" width="150">';
	$mail_message .= '</td>';
...
function mail_template_footer()
{
	...
	$mail_message .= '<a href="javascript.void(0);"><img src="http://www.garnishd.com/img/footer-fb.png"></a> &nbsp; ';
	$mail_message .= '<a href="javascript.void(0);"><img src="http://www.garnishd.com/img/footer-tw.png"></a> &nbsp; ';
	$mail_message .= '<a href="javascript.void(0);"><img src="http://www.garnishd.com/img/footer-in.png"></a> &nbsp; ';
	$mail_message .= '<a href="javascript.void(0);"><img src="http://www.garnishd.com/img/footer-gl.png"></a></td>';
	$mail_message .= '</tr>';
	$mail_message .= '</table></td>';
	$mail_message .= '</tr>';
	$mail_message .= '</table></td>';
...
function randomString($query,$col_name,$length)
{
	global $db_con;
...
{
	$headers = "From: \"garnishd\" <support@garnishd.com>\n";
	$headers .= "Return-Path: <support@garnishd.com>\n";
	...
	?>
    	<div id="navigation">
			<div class="container-fluid" >
				<a href="view_dashboard.php?pag=Dashboard" id="brand">Garnishd<!--<img src="img/logo.png" style="height:40px;">--></a>
				<!-- main menu -->
            	<?php 
